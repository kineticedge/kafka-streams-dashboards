...
#declare -a HOSTS=(broker-1 broker-2 broker-3 broker-4 broker-1-lb broker-2-lb broker-3-lb broker-4-lb)
declare -a HOSTS=(broker-1-lb broker-2-lb broker-3-lb broker-4-lb)
